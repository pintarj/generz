...
describe('interval', () => {
    ...
    test('non-integer-params', () => {
        const c0 = () => new IntegerInterval(2.1, 4)
        const c1 = () => new IntegerInterval(2, 4.1)
        const c2 = () => new IntegerInterval(2.1, 4.1)
        expect(c0).toThrow('Integer interval must have integer boundaries.')
        expect(c1).toThrow('Integer interval must have integer boundaries.')
        expect(c2).toThrow('Integer interval must have integer boundaries.')
    })
    
    test('negative-length', () => {
        const callback = () => new IntegerInterval(10, 5)
        expect(callback).toThrow('Integer interval must have non-negative length.')
    })
...
describe('set', () => {
    ...
    describe('calculate-differences-and-intersection', () => {
